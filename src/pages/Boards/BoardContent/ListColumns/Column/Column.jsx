...
function Column({ column }) {
  ...
  const dndKitColumnStyles = {
    ...
    transition,
    // Chiều cao phải luôn max 100% vì nếu không sẽ lỗi lúc kéo column ngắn qua một column dài thì phải kéo ở khu vực giữa. Lưu ý lúc này phải kết hợp với {...listeners} nằm ở Box chứ không phải nằm ở Div ngoài để tránh trường hợp kéo vào vùng xanh.
    height: '100%',
  ...
  const addNewCard = async () => {
    ...
    // Tương tụ hàm createNewColumn nên chỗ này dùng clonedeep
